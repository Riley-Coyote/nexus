...
export default function PrivatePostPageClient({ post, parent, childPosts }: PrivatePostPageClientProps) {
  ...
  if (nexusData.isLoading) {
    return (
      <div className="liminal-logbook min-h-screen flex flex-col bg-app-background">
        <Header currentMode="logbook" currentView="feed" currentUser={currentUser} />
